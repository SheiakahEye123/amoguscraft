...
public class ModdedPanel extends JPanel {
    ...
    protected void paintComponent(Graphics brush) {
        ...
        System.out.println(testAngleHor);
        ...
        // point #1 draw
        brush.fillOval((int)point.screenx*100+ getHeight()/2, (int)point.screeny*100 + getWidth()/2, (int)(200*(1/x)),(int)(200*(1/x)));
        brush.setColor(Color.red);
        // point #2 draw
        brush.fillOval((int)point2.screenx*100 + getHeight()/2, (int)point2.screeny*100 + getWidth()/2, (int)(200*(1/x)),(int)(200*(1/x)));
